...
class UpperAirSounding(object):
    ...
    def __init__(self, bufr_file, accent_only=False):
        ...
        content = sorted(bufr_file.data.to_dict(filter_keys=['SMID', 'YEAR', 'MNTH', 'DAYS', 'HOUR', 'MINU', 'SECO', 'CLATH', 'CLONH', 'HSMSL', 'LTDS', 'PRLC', 'GPH10', 'LATDH', 'LONDH', 'TMDB', 'TMDP', 'WDIR', 'WSPD']), key=lambda a: a['LTDS'])
